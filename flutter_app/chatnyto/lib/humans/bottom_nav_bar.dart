...
class _BottomNavigationBarWidgetState extends State<BottomNavigationBarWidget>
  ...
  Widget build(BuildContext context) {
    return BottomNavigationBar(
      ...
      items: [
        buildNavItem('assets/humans/chat.svg', 0),
        buildNavItem('assets/humans/connections.svg', 1),
        buildNavItem('assets/humans/heatmap.svg', 2),
        buildNavItem('assets/humans/parameters.svg', 3),
      ],
