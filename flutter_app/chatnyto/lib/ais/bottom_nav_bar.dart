...
class _BottomNavigationBarWidgetState extends State<BottomNavigationBarWidget>
  ...
  Widget build(BuildContext context) {
    return BottomNavigationBar(
      ...
      items: [
        buildNavItem('assets/ais/terminal-page.svg', 0),
        buildNavItem('assets/ais/parameters-page.svg', 1),
        buildNavItem('assets/ais/notebook-page.svg', 2),
        buildNavItem('assets/ais/lineage-graph-page.svg', 3),
      ],
