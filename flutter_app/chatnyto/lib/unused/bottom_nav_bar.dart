...
class _BottomNavigationBarWidgetState extends State<BottomNavigationBarWidget>
  ...
  Widget build(BuildContext context) {
    return BottomNavigationBar(
      ...
      items: [
        buildNavItem('assets/terminal-page.svg', 0),
        buildNavItem('assets/parameters-page.svg', 1),
        buildNavItem('assets/notebook-page.svg', 2),
        buildNavItem('assets/lineage-graph-page.svg', 3),
      ],
